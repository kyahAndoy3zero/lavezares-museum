      ...
      <div className='px-8 py-8 mx-auto mt-5 mb-10 border-2 rounded-xl lg:w-5/12 md:w-6/12 sm:w-11/12'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-start mb-6">
            ...
            <label htmlFor="terms" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with the <button className="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</button></label>
          </div>
